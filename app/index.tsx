...
const palette = {
  background: "#090E1A",
  calendarPanel: "#10284A",
  calendarPanelBorder: "rgba(157, 190, 232, 0.24)",
  calendarText: "#F4F8FF",
  calendarMuted: "#C7D8F2",
  divider: "rgba(157, 190, 232, 0.36)",
  surface: "#20314D",
  surfaceSelected: "#345583",
  surfaceBorder: "#526D93",
  surfaceBorderSelected: "#A9D0FF",
  text: "#F4F8FF",
  mutedText: "#D3DEEF",
  accent: "#A9D0FF",
  today: "#F2CC62",
